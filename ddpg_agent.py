...
class Agent():
    ...
    def __init__(self, state_size, action_size, num_agents, random_seed, actor_hidden_layers, critic_hidden_layers):
        ...
        self.actor_local = Actor(state_size, action_size, random_seed, actor_hidden_layers).to(device)
        self.actor_target = Actor(state_size, action_size, random_seed, actor_hidden_layers).to(device)
        self.actor_optimizer = optim.Adam(self.actor_local.parameters(), lr=LR_ACTOR, weight_decay=WEIGHT_DECAY_actor)

        # Critic Network (w/ Target Network)
        self.critic_local = Critic(state_size, action_size, random_seed, critic_hidden_layers).to(device)
        self.critic_target = Critic(state_size, action_size, random_seed, critic_hidden_layers).to(device)
